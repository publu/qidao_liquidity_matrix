module TokensHelper
    ...
    def self.permissions_grade(token)
    ...
    def self.marketcap_grade(token)
    ...
    def self.volatility_grade(token)
    ...
    def self.grade_to_number(grade)
      if grade == "A+"
        "97"
      elsif grade == "A"
        "94"
